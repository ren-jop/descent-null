...
impl CharacterControllerBundle {
    pub fn new(collider: Collider) -> Self {
        ...
        Self {
            ...
            // Return-to-surface is now part of the mission, so jumps need
            // enough height to traverse the deliberately climbable platform
            // spacing generated by world::cave.
